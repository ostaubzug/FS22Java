...
public final class Temperature implements Comparable<Temperature>
{
    ...
    private Temperature(float kelvin, LocalDateTime timestamp)
    {
        if(kelvin < 0){
    ...
    public static Temperature createFromCelsius(final float celsius, LocalDateTime timestamp){
        return new Temperature(convertCelsiusToKelvin(celsius), timestamp);
    }

    public static Temperature createFromKelvin(final float kelvin, LocalDateTime timestamp){
        return new Temperature(kelvin, timestamp);
    }
    ...
    public String toString(){
        return "Temperature [Kelvin: " + getKelvin() + getTimestamp() + "]";
    }
